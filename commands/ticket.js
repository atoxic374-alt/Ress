...
async function buildFeedbackCardImage({ guild, member, stars, comment, style = {} }) {
  ...
  bg.addColorStop(0, normalizeHexColor(style.background, '#050b20'));
  bg.addColorStop(1, '#0a1533');
  ctx.fillStyle = bg;
  ...
  cardGrad.addColorStop(0, normalizeHexColor(style.cardStart, '#4f3b93'));
  cardGrad.addColorStop(1, normalizeHexColor(style.cardEnd, '#6d59b0'));
